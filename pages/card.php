    ...
    if ($product_id) {
        ...
        try {
            ...
            $query = "SELECT
                    ...
                    p.storage_count AS storage_count
  ...
  <body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr><th>Количество на складе</th><td><?= htmlspecialchars($product['storage_count'] ?? '') ?></td></tr>
                </tbody>
            </table>
        </div>
		<!-- Right Column -->
        <div class="col-md-4">
            ...
            <div class="mb-2">
                <button class="btn btn-main-1 w-100 mb-2" id="add-to-cart" data-product-id="<?= $product['product_id'] ?>">Добавить в корзину</button>
